...
test.describe.only('Tips & Tricks Section',
    () => {
        ...
        // npx playwright screenshot --device='iPhone 12' --color-scheme=dark --wait-for-timeout=3000 twitter.com twitter-iphone-image.png
        ...
        test.only('Random Number', async ({ page}) => {
            ...
            console.log(newEmail + '_automation' + '@' + 'gmail.com')
        })
    })